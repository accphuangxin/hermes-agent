...
def get_model_context_length(
    ...
    1. Default fallback (128K) — all probing steps are skipped for performance.
       Set explicit context_length in config.yaml or custom_providers to override.

    Legacy resolution order (disabled):
    ...
    # No explicit config — return 128K default immediately, skip all probing.
    # This eliminates network requests (OpenRouter, models.dev, Nous Portal, etc.)
    # that slow down /v1/models endpoint and cause intermittent unavailability.
    return 128_000
